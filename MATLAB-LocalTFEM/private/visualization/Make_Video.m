...
title = sprintf('HeatedplateM%d-T%dto%.2fP%d.avi',mesh_choice,0,tFin,p);
...
clims = [0,2];
pos = [50, 50, 560, 420];
View_Soln(U(:,1), Elements, Nodes, map, sgn, p, Phi,how_rough);
...
View_Soln(U(:,i), Elements, Nodes, map, sgn, p, Phi,how_rough);
