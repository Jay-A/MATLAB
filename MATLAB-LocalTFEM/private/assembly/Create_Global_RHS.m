function [GRHS] = Create_Global_RHS(p, Num_Global_DoFs, Num_Elems, ...
    Nodes, Elements, Areas, sgn, map, F0, Psi)
...
for elem_cnt = 1:Num_Elems
    ...
    [Loc_RHS] = Eval_RHS(@(x,y) F0(x,y), Elem_Verts, Areas(elem_cnt), p, Psi);
